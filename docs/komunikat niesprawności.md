...
Mogą to być zarówno niesprawności układów regulacji na całe zasoby jak i, w odniesieniu do MWE hybrydowych, niesprawności na składowe takich MWE.
...
|----------|-----|-------------|:--------:|------|----------|
| `mainResourceMrid` | string | path | tak | mRID zasobu | `_d8736017-d25d-4952-a3cf-0fa83560e16f` |
| `unavailabilityMrid` | string | path | tak | mRID usterki | `12346017-d25d-4952-a3cf-0fa83560e160`` |
